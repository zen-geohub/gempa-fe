...
import { Chart as ChartJS, TimeScale, PointElement } from "chart.js";
        ...
        datasets: [
          {
            ...
            data: earthquake
              .filter(
                (feature) =>
                  feature.properties["depth_class"] === "Gempa Dangkal"
              )
              .map((feature) => {
                return {
                  ...
                  r:
                    feature.properties["magnitude_class"] === "Gempa Kecil"
                      ? 3
                      : feature.properties["magnitude_class"] ===
                        "Gempa Menengah"
                      ? 5
                      : feature.properties["magnitude_class"] === "Gempa Besar"
                      ? 7
                      : 9,
                };
              }),
          ...
          },
          {
            ...
            data: earthquake
              .filter(
                (feature) =>
                  feature.properties["depth_class"] === "Gempa Menengah"
              )
              .map((feature) => {
                return {
                  x: new Date(feature.properties["date"]).toISOString(),
          ...
          },
          {
            ...
            data: earthquake
              .filter(
                (feature) => feature.properties["depth_class"] === "Gempa Dalam"
              )
              .map((feature) => {
                return {
                  x: new Date(feature.properties["date"]).toISOString(),
      ...
      <Card className="w-1/2 h-full relative">
        ...
        <CardHeader className="p-0 text-center">
          <CardTitle className="text-sm">
            Distribusi Gempa berdasarkan Magnitudo
          </CardTitle>
        </CardHeader>
